...
def compareFps(single,multi,base,skip,cut):
    ...
    Bs =np.mean(base_se)
    Bm =np.mean(base_cl)
    print("S mult:{} sing:{}; \n C mult:{} sing:{} \n B client:{} server:{}".format(Smult,Ssing,Cmult,Csing,Bm,Bs))
...
skip = 1000
cut = 26000
single = (ad+'fps1.txt',ad+'fps2.txt',ad+'fps3.txt')
multi = (ad+'fpsA.txt',ad+'fpsB.txt',ad+'fpsC.txt')
base =('S/S1.txt','S/S2.txt','S/S3.txt')
print(ad)
